...
# Create a new driver
create_driver fifo_uart_driver

# Associate it with some hardware known as "altera_avalon_uart"
set_sw_property hw_class_name avl_fifo_uart
...
# C/C++ source files
add_sw_property c_source src/avl_fifo_uart.c
add_sw_property c_source src/avl_fifo_uart_fd.c
