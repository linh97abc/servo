...
#define SERVO_CONTROLLER_FLAG_CTRL_STEP_PENDING_BIT (1u << 15)

#define SERVO_CONTROLLER_FLAG_HALL_ERR3_BIT (1u << 14)
#define SERVO_CONTROLLER_FLAG_HALL_ERR2_BIT (1u << 13)
#define SERVO_CONTROLLER_FLAG_HALL_ERR1_BIT (1u << 12)
#define SERVO_CONTROLLER_FLAG_HALL_ERR0_BIT (1u << 11)
...
#define SERVO_CONTROLLER_IE_HALL_ERR3_BIT (1u << 14)
#define SERVO_CONTROLLER_IE_HALL_ERR2_BIT (1u << 13)
#define SERVO_CONTROLLER_IE_HALL_ERR1_BIT (1u << 12)
#define SERVO_CONTROLLER_IE_HALL_ERR0_BIT (1u << 11)

#define SERVO_CONTROLLER_IE_DRV8320_FAULT3_BIT (1u << 10)
#define SERVO_CONTROLLER_IE_DRV8320_FAULT2_BIT (1u << 9)
#define SERVO_CONTROLLER_IE_DRV8320_FAULT1_BIT (1u << 8)
#define SERVO_CONTROLLER_IE_DRV8320_FAULT0_BIT (1u << 7)

#define SERVO_CONTROLLER_IE_STOP3_BIT (1u << 6)
#define SERVO_CONTROLLER_IE_STOP2_BIT (1u << 5)
#define SERVO_CONTROLLER_IE_STOP1_BIT (1u << 4)
#define SERVO_CONTROLLER_IE_STOP0_BIT (1u << 3)

#define SERVO_CONTROLLER_IE_ADC_VALID_BIT (1u << 2)
#define SERVO_CONTROLLER_IE_MEA_TRIG_BIT (1u << 1)
#define SERVO_CONTROLLER_IE_REALTIME_ERR_BIT (1u << 0)
