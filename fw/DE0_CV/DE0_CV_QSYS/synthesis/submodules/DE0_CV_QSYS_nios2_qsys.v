...
module DE0_CV_QSYS_nios2_qsys (
		...
		input  wire [31:0] itcm1_readdata,                      // tightly_coupled_instruction_master_1.readdata
		output wire [27:0] itcm1_address,                       //                                     .address
		output wire        itcm1_read,                          //                                     .read
		output wire        itcm1_clken,                         //                                     .clken
	...
	DE0_CV_QSYS_nios2_qsys_cpu cpu (
		...
		.itcm1_readdata                      (itcm1_readdata),                      // tightly_coupled_instruction_master_1.readdata
		.itcm1_address                       (itcm1_address),                       //                                     .address
		.itcm1_read                          (itcm1_read),                          //                                     .read
		.itcm1_clken                         (itcm1_clken),                         //                                     .clken
		.irq                                 (irq),                                 //                                  irq.irq
